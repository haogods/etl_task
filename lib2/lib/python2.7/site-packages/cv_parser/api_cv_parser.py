...
from cv_parser_liepin import CvParserLiepin
from cv_parser_highpin import CvParserHighPin
...
if __name__=="__main__":
    ...
    path = './test_cvs/cv_51job/'
    fnames = [ path+fname for fname in os.listdir(path) if fname.endswith(".html")][:500]
    ...
    # http　接口直接调用示范
    htmlContent = codecs.open("./test_cvs/cv_zhilian/JM001946527R90250000000.html",'rb','utf-8').read()
