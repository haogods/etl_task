...
class JdJobRaw(object):
  ...
  def __init__(self, jobPosition=None, jobSalary=None, jobNum=None, jobWorkLoc=None, jobDiploma=None, jobCate=None, jobType=None, jobWelfare=None, gender=None, age=None, certList=None, jobMajorList=None, skillList=None, workDemand=None, workDuty=None, jobDesc=None, jobWorkAge=None, others=None,):
...
class JdRaw(object):
  ...
  thrift_spec = (
    ...
    (7, TType.STRING, 'endTime', None, None, ), # 7
  )
...
class JdJobMeasure(object):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i34 in xrange(_size30):
            ...
            self.jobMajorList.append(_elem35)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.jobMajorList is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.jobMajorList))
      for iter36 in self.jobMajorList:
...
class JdMeasure(object):
  ...
  def __init__(self, jdId=None, jdFrom=None, jdUrl=None, jdInc=None, jdJob=None, pubDate=None, endDate=None,):
    self.jdId = jdId
    self.jdFrom = jdFrom
    self.jdUrl = jdUrl
    self.jdInc = jdInc
...
class JdMergedInfo(object):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i53 in xrange(_size49):
            ...
            self.jobTagList.append(_elem54)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 100:
  ...
  def write(self, oprot):
    ...
    if self.skillList is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.skillList))
      for iter56 in self.skillList:
        oprot.writeString(iter56.encode('utf-8'))
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.workDemand is not None:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i68 in xrange(_size64):
            ...
            self.descVector.append(_elem69)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
